...
## --- Palette --------------- ##
# RStudio and UI
chunk  <- "#E3D4E3"    # Chunk background,
page.1 <- "#EBE0E6"    # Page background, inactive tab background
page.2 <- "#DDCAD4"    # Frames: Toolbar, gutter and scroll bar background
page.3 <- "#CDB1BF"    # Window frames, selection, margin line, scroll handle
text.1 <- "#A5738C"    # Inactive tab text
text.2 <- "#7C5066"    # Gutter foreground, brackets
text.3 <- "#503040"    # Foregrounds: Code, text, Rstudio, and Rmd headings 
...
## --- Create Theme --------------- ##
rsthemes::rstheme(
  theme_name = "~ Barbie Girl",
  theme_path = "barbieGirl.rstheme",
